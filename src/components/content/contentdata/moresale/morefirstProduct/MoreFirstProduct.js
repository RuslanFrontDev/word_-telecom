...
//qalanmen ederem mellım ezıyyet cekmeyın
const MoreFirstProduct = () => {
  const { filteredDatas, loading, error } = useSelector(
    (state) => state.moresale
  );
  const arr = filteredDatas?.slice(8, 10);
  return (
    <>
                      ...
                      <Link to="mehsul">
                        <div className="manat-month">
                          <div className="cartAmount">
                            <div className="manat">
                              <div>
                                <p>{moreproduct.price}</p>
                              </div>
                            </div>
                            <div className="cartAmount-month">
                              <p>{moreproduct.month} <Icon name="cartManat"/></p>
                              <p>
...
export default MoreFirstProduct;
